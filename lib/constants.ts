...
// syncing - see needsOddsSync there. Much wider than SYNC_WINDOW_MS: betting
// lines move for a full day or more before kickoff, not just in the last 15
// minutes, which is all that matters for a game's score/status.
